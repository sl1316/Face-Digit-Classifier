...
class Datum:
  ...
  def __init__(self, data,width,height):
    ...
    #self.pixels = (np.transpose(convertToInteger(data))).tolist()
...
def loadDataFile(filename,width,height):
  """
 ...
 # print fin
  fin.reverse()#reverse the string array
  items = []
  #for i in range(n):
  for i in range(len(fin)/height):
    data = []
